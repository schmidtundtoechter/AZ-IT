...
frappe.ui.form.on('Sales Order Item', {
    ...
    custom_rabatt_in_prozent: function(frm, cdt, cdn) {
        ...
        // Update description
        update_discount_description_sales_order(frm, cdt, cdn, discount);
    },
...
function update_discount_description_sales_order(frm, cdt, cdn, discount_percent) {
    let row = locals[cdt][cdn];
    let description = row.description || '';

    // Remove any existing discount line
    description = remove_discount_line_sales_order(description);
...
function ensure_blank_line_after_discount_sales_order(description) {
...
function remove_discount_line_sales_order(description) {
